import { GUANTE_DE_ORO } from "../../../../constants/GUANTE_DE_ORO";

const GuanteDeOroComponent = () => {
  return (
    <div className="overflow-x-auto">
      ...
      <p className="mt-4 text-sm italic text-center text-gray-600">
        El <b>Guante de oro</b> se otorga al arquero que durante una liga recibe
        la menor cantidad de goles.
      </p>
    </div>
  );
};

export default GuanteDeOroComponent;
