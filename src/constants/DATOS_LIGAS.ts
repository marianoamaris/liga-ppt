...
export const LIGA_14 = {
  ...
  goleadoresTotales: [
    ...
    { jugador: "Andrés Farfán", goles: 4 },
    { jugador: "Sergio Barrera", goles: 3 },
    { jugador: "Keni Contreras", goles: 3 },
    { jugador: "Jefferson Almanza", goles: 2 },
    { jugador: "Cristian Trujillo", goles: 2 },
    { jugador: "Kevin Pineda", goles: 2 },
    { jugador: "Andy Córdoba (Pingui)", goles: 2 },
    { jugador: "Juan Dybala", goles: 2 },
    { jugador: "Emanuel Navarro (Goat)", goles: 2 },
    { jugador: "Carlos Romero", goles: 2 },
    { jugador: "Ronald Rojas", goles: 2 },
    { jugador: "Jeison Santa", goles: 2 },
    ...
    { jugador: "Dairo Martínez", goles: 1 },
    { jugador: "Jeysson Henríquez", goles: 1 },
    { jugador: "Carlos Armenta", goles: 1 },
    { jugador: "Emanuel Celedón", goles: 1 },
    { jugador: "José Hernández", goles: 1 },
    { jugador: "Arnold Castillo", goles: 1 },
    { jugador: "Daniel Cuadros", goles: 1 },
    { jugador: "Fabricio Rizo", goles: 1 },
    { jugador: "Santiago Corzo", goles: 1 },
    { jugador: "Bryan Pallares", goles: 1 },
    { jugador: "Sergio Blanchar", goles: 1 },
  ],
  goleadorLiga: { jugador: "Keiler Fonseca", goles: 4 },
  arqueros: [
    { arquero: "Carlos Barraza", golesRecibidos: 2 },
    { arquero: "Camilo Laborde", golesRecibidos: 4 },
    { arquero: "Brayan Ospino", golesRecibidos: 5 },
    { arquero: "Pipe Castillejo", golesRecibidos: 5 },
    { arquero: "Santiago Sánchez", golesRecibidos: 6 },
    { arquero: "Brayan Cadena", golesRecibidos: 7 },
    { arquero: "Nicolás Baute", golesRecibidos: 7 },
    { arquero: "Fernando Gómez", golesRecibidos: 7 },
    { arquero: "Leonardo Cadena", golesRecibidos: 9 },
  ],
  mejorArquero: { arquero: "Carlos Barraza", golesRecibidos: 2 },
  cuartos: [],
  semifinales: [],
  final: "",
  ganador: "",
