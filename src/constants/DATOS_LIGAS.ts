...
export const TEAM_COLORS_LIGA_15: Record<string, string> = {
  "Palermo FC": "#FF69B4", // rosado
  "Luton Town FC": "#F97316", // naranja
  "Leicester City": "#2563EB", // azul
  "Deportivo Cali": "#22C55E", // verde
...
export const LIGA_14 = {
  ...
  goleadoresTotales: [
    { jugador: "José Hernández", goles: 26 },
    { jugador: "Víctor Castilla (Toto)", goles: 23 },
    { jugador: "Andrés Farfán", goles: 22 },
    { jugador: "Jürgen Hassler", goles: 20 },
    { jugador: "Keiler Fonseca", goles: 16 },
    { jugador: "Jeison Santa", goles: 15 },
    { jugador: "Andrés Salazar", goles: 15 },
    { jugador: "Dairo Martínez", goles: 14 },
    { jugador: "Jairo Galván", goles: 12 },
    { jugador: "Juan DLC", goles: 12 },
    { jugador: "Ronald Rojas", goles: 10 },
    { jugador: "Andy Córdoba (Pingui)", goles: 10 },
    { jugador: "José Mosquera", goles: 9 },
    { jugador: "Santiago Corzo", goles: 9 },
    { jugador: "Juan Dybala", goles: 8 },
    { jugador: "Emanuel Navarro (Goat)", goles: 8 },
    { jugador: "Keni Contreras", goles: 8 },
    { jugador: "Jefferson Almanza", goles: 8 },
    { jugador: "Arnold Castillo", goles: 7 },
    { jugador: "Carlos Armenta", goles: 7 },
    { jugador: "Kevin Pineda", goles: 7 },
    { jugador: "Cristian Trujillo", goles: 6 },
    { jugador: "Mariano Amaris", goles: 6 },
    { jugador: "Sergio Barrera", goles: 6 },
    { jugador: "Cristian Benjumea", goles: 5 },
    { jugador: "Carlos Romero", goles: 5 },
    { jugador: "Miguel Guerra", goles: 4 },
    { jugador: "Daniel Cuadros", goles: 4 },
    { jugador: "Hernán Medrano", goles: 4 },
    { jugador: "Camilo Laborde", goles: 3 },
    { jugador: "Jesús Pertuz", goles: 3 },
    { jugador: "José Viña", goles: 3 },
    { jugador: "Bryan Pallares", goles: 3 },
    { jugador: "Juan Tellez", goles: 3 },
    { jugador: "Juan Vargas", goles: 3 },
    { jugador: "Narent Rojas", goles: 3 },
    { jugador: "Fabricio Rizo", goles: 3 },
    { jugador: "Juanse Tibaduiza", goles: 2 },
    { jugador: "Alejandro Macherna", goles: 2 },
    { jugador: "Juanse Pinedo", goles: 2 },
    { jugador: "Omar Peralta", goles: 2 },
    { jugador: "Emanuel Celedón", goles: 2 },
    { jugador: "Alexander Benitez", goles: 2 },
    { jugador: "Nadim Camall", goles: 2 },
    { jugador: "José Henao 2", goles: 2 },
    { jugador: "Nico Yamal", goles: 1 },
    { jugador: "Frederick Molina", goles: 1 },
    { jugador: "Jesús Solano", goles: 1 },
    { jugador: "Yassir Fuentes", goles: 1 },
    { jugador: "Eudes Pavajeau", goles: 1 },
    { jugador: "Jhonnier DLC", goles: 1 },
    { jugador: "Breiner Corzo (Mene)", goles: 1 },
    { jugador: "Libardo del 5", goles: 1 },
    { jugador: "Fernando Gómez", goles: 1 },
    { jugador: "Elías Lacera", goles: 1 },
    { jugador: "Camilo Torres", goles: 1 },
    { jugador: "Edwin Martínez", goles: 1 },
    { jugador: "Henry Hernandez", goles: 1 },
    { jugador: "Edward Brito (Titi)", goles: 1 },
  ...
  arqueros: [
    { arquero: "Leonardo Cadena", golesRecibidos: 30 },
    { arquero: "Carlos Barraza", golesRecibidos: 37 },
    { arquero: "Fernando Gómez", golesRecibidos: 38 },
    { arquero: "Brayan Ospino", golesRecibidos: 38 },
    { arquero: "Camilo Laborde", golesRecibidos: 42 },
    { arquero: "Edison Mejía (Gato)", golesRecibidos: 42 },
    { arquero: "Pipe Castillejo", golesRecibidos: 43 },
    { arquero: "Juan Mora", golesRecibidos: 47 },
    { arquero: "Brayan Cadena", golesRecibidos: 49 },
  ],
  mejorArquero: { arquero: "Leonardo Cadena", golesRecibidos: 30 },
  cuartos: ["Brasil 🏆 7 - Palermo FC 5", "Wolverhampton 7 - River Plate 6"],
  semifinales: [
    "Brasil 🏆 6 - Junior 6 (Brasil gana penales 1-0)",
    "VfL Wolfsburgo 8 - Wolverhampton 4",
  ],
...
export const LIGA_15 = {
  ...
  goleadoresTotales: [
    { jugador: "Santiago Corzo", goles: 26 },
    { jugador: "Eduardo Sarmiento (Mou)", goles: 25 },
    { jugador: "José Hernández", goles: 21 },
    { jugador: "Jossimar Cujia (Pollo)", goles: 21 },
    { jugador: "Yassir Fuentes", goles: 20 },
    { jugador: "Keiler Fonseca", goles: 18 },
    { jugador: "Jürgen Hassler", goles: 14 },
    { jugador: "Edwin Martínez", goles: 12 },
    { jugador: "Keni Contreras", goles: 11 },
    { jugador: "José Franco", goles: 11 },
    { jugador: "Sergio Barrera", goles: 10 },
    { jugador: "Dairo Martínez", goles: 10 },
    { jugador: "Juanda Dybala", goles: 9 },
    { jugador: "Nico Yamal", goles: 8 },
    { jugador: "Andrés Farfán", goles: 8 },
    { jugador: "Ronald Rojas", goles: 8 },
    { jugador: "Kevin Pineda", goles: 7 },
    { jugador: "Andy Córdoba (Pingui)", goles: 7 },
    { jugador: "Carlos Armenta", goles: 7 },
    { jugador: "Arnold Castillo", goles: 7 },
    { jugador: "Jeison Santa", goles: 7 },
    { jugador: "Carlos Romero", goles: 7 },
    { jugador: "Hernán Medrano", goles: 6 },
    { jugador: "Esteban Hinojosa (Wara)", goles: 6 },
    { jugador: "Narent Rojas", goles: 6 },
    { jugador: "José Mosquera", goles: 6 },
    ...
    { jugador: "Juan Tellez", goles: 3 },
    { jugador: "Filgar Morales", goles: 3 },
    { jugador: "Emanuel Navarro (Goat)", goles: 3 },
    { jugador: "Daniel Trillos", goles: 3 },
    { jugador: "Jaime Machado", goles: 2 },
    { jugador: "Emanuel Celedón", goles: 2 },
    { jugador: "Esteban Galván", goles: 2 },
    { jugador: "Eudes Pavajeau", goles: 2 },
    { jugador: "Kevin Gómez", goles: 2 },
    { jugador: "Nadim Camall", goles: 2 },
    { jugador: "Daniel Cuadros", goles: 2 },
    { jugador: "Frank Ramírez", goles: 2 },
    { jugador: "Jesús Pertuz", goles: 2 },
    { jugador: "Elías Lacera", goles: 2 },
    { jugador: "Edward Brito (Titi)", goles: 2 },
    { jugador: "Breiner Corzo (Mene)", goles: 2 },
    { jugador: "Bryan Pallares", goles: 1 },
    { jugador: "Frederick Molina", goles: 1 },
    { jugador: "Carlos Vega", goles: 1 },
    { jugador: "Juanse Tibaduiza", goles: 1 },
    { jugador: "Jesús Solano", goles: 1 },
    { jugador: "Óscar Mendoza", goles: 1 },
    { jugador: "Ronaldo Iglesia", goles: 1 },
    { jugador: "Jhan C. Martínez", goles: 1 },
    { jugador: "Omar Peralta", goles: 1 },
    { jugador: "José Viña", goles: 1 },
    { jugador: "José Carrascal", goles: 1 },
    { jugador: "Camilo Laborde", goles: 1 },
    { jugador: "Jairo Galván", goles: 1 },
  ],
  goleadorLiga: { jugador: "Santiago Corzo", goles: 26 },
  arqueros: [
    { arquero: "Fernando Gómez", golesRecibidos: 29 },
    { arquero: "Andrés Ramírez", golesRecibidos: 36 },
    { arquero: "Camilo Laborde", golesRecibidos: 41 },
    { arquero: "Pipe Castillejo", golesRecibidos: 41 },
    { arquero: "Jefferson Maestre", golesRecibidos: 41 },
    { arquero: "Brayan Ospino", golesRecibidos: 44 },
    { arquero: "Brayan Cadena", golesRecibidos: 45 },
    { arquero: "Lucho Torres", golesRecibidos: 47 },
    { arquero: "Nicolas Baute", golesRecibidos: 47 },
  ],
  mejorArquero: { arquero: "Fernando Gómez", golesRecibidos: 29 },
  cuartos: [
    "Luton Town FC (3) 🟠 vs Deportivo Cali (6) 🟢 - Domingo 19 Oct 7:00 PM",
    "DC United (4) ⚫ vs Al-Ahly (5) 🔴 - Domingo 19 Oct 8:00 PM",
  ],
  semifinales: [
    "Semifinal A: Leicester City 🔵 vs DC United ⚫ o Al-Ahly 🔴",
    "Semifinal B: Valencia CF ⚪ vs Luton Town FC 🟠 o Deportivo Cali 🟢",
  ],
  final: "",
  ganador: "",
};
