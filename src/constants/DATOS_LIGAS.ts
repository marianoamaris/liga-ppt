...
export const LIGA_15 = {
  ...
  goleadoresTotales: [
    { jugador: "Eduardo Sarmiento (Mou)", goles: 7 },
    { jugador: "José Hernández", goles: 5 },
    { jugador: "Dairo Martínez", goles: 4 },
    { jugador: "Jossimar Cujia (Pollo)", goles: 4 },
    { jugador: "Daniel Trillos", goles: 3 },
    { jugador: "Keiler Fonseca", goles: 3 },
    { jugador: "Santiago Corzo", goles: 3 },
    { jugador: "Carlos Romero", goles: 3 },
    { jugador: "Jeison Santa", goles: 3 },
    { jugador: "Carlos Armenta", goles: 2 },
    { jugador: "Emanuel Navarro (Goat)", goles: 2 },
    { jugador: "Kevin Pineda", goles: 2 },
    { jugador: "Arnold Castillo", goles: 2 },
    { jugador: "José Franco", goles: 2 },
    { jugador: "Ronald Rojas", goles: 2 },
    { jugador: "Andrés Farfán", goles: 2 },
    { jugador: "Sergio Barrera", goles: 2 },
    { jugador: "Yassir Fuentes", goles: 2 },
    { jugador: "Narent Rojas", goles: 2 },
    { jugador: "José Viña", goles: 1 },
    { jugador: "Jürgen Hassler", goles: 1 },
    { jugador: "Edward Brito (Titi)", goles: 1 },
    { jugador: "José Carrascal", goles: 1 },
    { jugador: "José Mosquera", goles: 1 },
    { jugador: "Cristian Benjumea", goles: 1 },
    { jugador: "Sergio Blanchar", goles: 1 },
    { jugador: "Juan DLC", goles: 1 },
    { jugador: "Camilo Laborde", goles: 1 },
    { jugador: "Hernán Medrano", goles: 1 },
    { jugador: "Jairo Galván", goles: 1 },
    { jugador: "Breiner Corzo (Mene)", goles: 1 },
    { jugador: "Juan Tellez", goles: 1 },
  ],
  goleadorLiga: { jugador: "Eduardo Sarmiento (Mou)", goles: 7 },
  arqueros: [],
