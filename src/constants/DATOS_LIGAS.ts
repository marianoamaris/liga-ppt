...
export const LIGA_14 = {
  ...
  goleadoresTotales: [
    { jugador: "José Hernández", goles: 14 },
    { jugador: "Andrés Farfán", goles: 10 },
    { jugador: "Jürgen Hassler", goles: 9 },
    { jugador: "Jeison Santa", goles: 8 },
    { jugador: "Keiler Fonseca", goles: 8 },
    { jugador: "Andrés Salazar", goles: 7 },
    { jugador: "Dairo Martínez", goles: 7 },
    { jugador: "Juan DLC", goles: 6 },
    { jugador: "Kevin Pineda", goles: 6 },
    { jugador: "Ronald Rojas", goles: 6 },
    { jugador: "Keni Contreras", goles: 6 },
    { jugador: "Juan Dybala", goles: 6 },
    { jugador: "Mariano Amaris", goles: 5 },
    { jugador: "Santiago Corzo", goles: 5 },
    { jugador: "Emanuel Navarro (Goat)", goles: 5 },
    { jugador: "Víctor Castilla (Toto)", goles: 5 },
    { jugador: "Sergio Barrera", goles: 5 },
    { jugador: "Jairo Galván", goles: 4 },
    { jugador: "Carlos Romero", goles: 4 },
    { jugador: "Andy Córdoba (Pingui)", goles: 4 },
    ...
    { jugador: "José Viña", goles: 1 },
    { jugador: "Henry Hernandez", goles: 1 },
    { jugador: "Alejandro Macherna", goles: 1 },
  ...
  goleadorLiga: { jugador: "José Hernández", goles: 14 },
  arqueros: [
    { arquero: "Carlos Barraza", golesRecibidos: 16 },
    { arquero: "Leonardo Cadena", golesRecibidos: 17 },
    { arquero: "Brayan Ospino", golesRecibidos: 18 },
    { arquero: "Pipe Castillejo", golesRecibidos: 19 },
    { arquero: "Camilo Laborde", golesRecibidos: 21 },
    { arquero: "Fernando Gómez", golesRecibidos: 21 },
    { arquero: "Brayan Cadena", golesRecibidos: 21 },
    { arquero: "Santiago Sánchez", golesRecibidos: 21 },
